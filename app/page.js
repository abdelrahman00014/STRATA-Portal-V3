    ...
    <main className="min-h-screen p-8">
      <header className="text-center mb-10">
        <h1 className="text-3xl font-bold text-blue-800">
          StrataSphere Management Portal
        </h1>
        <p className="text-gray-600">
          Simplifying community living through effective management
        </p>
      </header>
      ...
      <section className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <div className="border-b pb-4 mb-4">
          ...
          <p>The annual meeting will be held in the common room at 7:00 PM.</p>
        </div>
        <div>
          <h3 className="font-medium">Building Maintenance</h3>
          <p className="text-sm text-gray-500">April 10, 2025</p>
          <p>Exterior painting begins next week. Please clear balconies.</p>
        </div>
      </section>
